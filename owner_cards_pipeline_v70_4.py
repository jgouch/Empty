#!/usr/bin/env python3
"""Owner Card Pipeline — v70.4 (FaCTS Section Validation + Full Snapshots + NeedsReviewNotes)
...
Run:
  python3 owner_cards_pipeline_v70_4.py
  or
  python3 owner_cards_pipeline_v70_4.py --pdf "B (all).pdf" --out "OwnerCards_B_Output.xlsx"
...
# --- OCR safety: prevent hangs (v70.4) ---
...
# --- Snapshot location: keep with script/batch folder (v70.4) ---
...
# -----------------------------
# v70.4 PROPERTY HEURISTICS (garden + coordinate OCR fuzz)
# -----------------------------
DEFAULT_GARDENS = [
    "GOOD SHEPHERD",
    "EVERLASTING LIFE",
...
# --- Structural / colon-style property detection (v70.4 fix) ---
    ...
    for tag, img_v in variants:
        ...
        for psm in psm_list:
            ...
            if sc > best_score:
                ...
                # v70.4: stop early when header OCR is already very strong
                if best_score >= 95:
                    break
